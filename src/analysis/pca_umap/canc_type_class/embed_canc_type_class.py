#!/usr/bin/env python3
"""Embed TCGA 5-type cancer-classification samples with the current backbone."""
...
OUTPUT_DIR = ROOT / "output" / "canc_type_class" / "pca_umap"
OUTPUT_PATH = OUTPUT_DIR / "canc_type_class_embeddings.npz"
...
adata.obs["cancer_type"] = (
    adata.obs["project"].astype(str).replace({"GBM": "GBM/LGG", "LGG": "GBM/LGG"})
)
